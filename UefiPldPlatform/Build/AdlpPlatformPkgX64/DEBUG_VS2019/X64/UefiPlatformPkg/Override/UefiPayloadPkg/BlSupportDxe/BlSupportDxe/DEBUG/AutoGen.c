...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC68DAA4E, 0x7AB5, 0x41e8, {0xA9, 0x1D, 0x59, 0x54, 0x42, 0x10, 0x53, 0xF3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BlSupportDxe";
...
{
  return BlDxeEntryPoint (ImageHandle, SystemTable);
}
