...
volatile  BOOLEAN _gPcd_BinaryPatch_PcdPciDisableBusEnumeration = _PCD_PATCHABLE_VALUE_PcdPciDisableBusEnumeration;
GLOBAL_REMOVE_IF_UNREFERENCED UINTN _gPcd_BinaryPatch_Size_PcdPciDisableBusEnumeration = 1;
