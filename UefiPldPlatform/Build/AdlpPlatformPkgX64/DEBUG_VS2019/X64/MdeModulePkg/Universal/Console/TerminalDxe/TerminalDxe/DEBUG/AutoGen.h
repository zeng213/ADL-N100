...
#define _PCD_TOKEN_PcdDefaultTerminalType  161U
#define _PCD_PATCHABLE_VALUE_PcdDefaultTerminalType  ((UINT8)0U)
extern volatile   UINT8  _gPcd_BinaryPatch_PcdDefaultTerminalType;
#define _PCD_GET_MODE_8_PcdDefaultTerminalType  _gPcd_BinaryPatch_PcdDefaultTerminalType
#define _PCD_PATCHABLE_PcdDefaultTerminalType_SIZE 1
#define _PCD_GET_MODE_SIZE_PcdDefaultTerminalType  _gPcd_BinaryPatch_Size_PcdDefaultTerminalType 
extern UINTN _gPcd_BinaryPatch_Size_PcdDefaultTerminalType; 
#define _PCD_SET_MODE_8_PcdDefaultTerminalType(Value)  (_gPcd_BinaryPatch_PcdDefaultTerminalType = (Value))
#define _PCD_SET_MODE_8_S_PcdDefaultTerminalType(Value)  ((_gPcd_BinaryPatch_PcdDefaultTerminalType = (Value)), RETURN_SUCCESS) 

#define _PCD_TOKEN_PcdErrorCodeSetVariable  73U
