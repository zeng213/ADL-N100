...
volatile  UINT8 _gPcd_BinaryPatch_PcdDefaultTerminalType = _PCD_PATCHABLE_VALUE_PcdDefaultTerminalType;
GLOBAL_REMOVE_IF_UNREFERENCED UINTN _gPcd_BinaryPatch_Size_PcdDefaultTerminalType = 1;
