...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC9602B47, 0x9569, 0x47C2, {0x9D, 0x1E, 0xFD, 0x1D, 0xF6, 0x7A, 0x72, 0xE4}};
...
{
  return PowerButtonEntry (ImageHandle, SystemTable);
}
