...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC3099578, 0xF815, 0x4a96, {0x84, 0xA3, 0xFC, 0x59, 0x37, 0x60, 0x18, 0x1D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmControlDxe";
...
{
  return SmmControl2Init (ImageHandle, SystemTable);
}
