...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x700A8874, 0xD215, 0x4ACC, {0x9E, 0xF2, 0x7A, 0x80, 0x12, 0x85, 0x60, 0xE0}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UfsPlatform";
...
{
  return UfsPlatformDriverEntryPoint (ImageHandle, SystemTable);
}
