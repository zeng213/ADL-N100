...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAA292DE7, 0xE11E, 0x42E6, {0x84, 0x6B, 0x58, 0x13, 0xA5, 0xA8, 0xD9, 0x82}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BlSwSmiHandler";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeBlSwSmi (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
