...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAD61999A, 0x507E, 0x47E6, {0xBA, 0x28, 0x79, 0xCC, 0x60, 0x9F, 0xA1, 0xA4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FspWrapperNotifyDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFspApiPerformanceGuid = { 0xc9122295, 0x56ed, 0x4d4e, { 0x06, 0xa6, 0x50, 0x8d, 0x89, 0x4d, 0x3e, 0x40 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFspHobGuid = { 0x6d86fb36, 0xba90, 0x472c, { 0xb5, 0x83, 0x3f, 0xbe, 0xd3, 0xfb, 0x20, 0x9a } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gIntelFsp2WrapperTokenSpaceGuid = { 0xa34cf082, 0xf50, 0x4f0d,  { 0x89, 0x8a, 0x3d, 0x39, 0x30, 0x2b, 0xc5, 0x1e } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFspHeaderFileGuid = { 0x912740BE, 0x2284, 0x4734, { 0xB9, 0x71, 0x84, 0xB0, 0x27, 0x35, 0x3F, 0x0C } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAddPerfRecordProtocolGuid = { 0xc4a58d6d, 0x3677, 0x49cb, { 0xa0, 0x0a, 0x94, 0x70, 0x76, 0x5f, 0xb5, 0x5e } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSkipFspApi = _PCD_VALUE_PcdSkipFspApi;
...
#define _PCD_VALUE_PcdFspmBaseAddress  0x00000000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdFspmBaseAddress = _PCD_VALUE_PcdFspmBaseAddress;
...
{
  return FspWrapperNotifyDxeEntryPoint (ImageHandle, SystemTable);
}
