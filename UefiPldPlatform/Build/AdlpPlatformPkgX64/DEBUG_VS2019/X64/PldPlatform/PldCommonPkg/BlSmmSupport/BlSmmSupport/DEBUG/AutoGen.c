...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x60F343E3, 0x2AE2, 0x4AA7, {0xB0, 0x1E, 0xBF, 0x9B, 0xD5, 0xC0, 0x4A, 0x3B}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BlSmmSupport";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (BlSmmSupport (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
