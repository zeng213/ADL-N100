...
################################################################################
[Defines]
  PLATFORM_NAME                       = UefiPlatformPkg
  PLATFORM_GUID                       = F71608AB-D63D-4491-B744-A99998C8CD97
  PLATFORM_VERSION                    = 0.1
  DSC_SPECIFICATION                   = 0x00010005
  SUPPORTED_ARCHITECTURES             = IA32|X64
  BUILD_TARGETS                       = DEBUG|RELEASE|NOOPT
  SKUID_IDENTIFIER                    = DEFAULT
  OUTPUT_DIRECTORY                    = Build/UefiPlatformPkgX64
  FLASH_DEFINITION                    = UefiPlatformPkg/PlatformPkg.fdf
