  ...
  )
{
  ...
  SpiInstance->PchSpiBase  = SpiFlashInfo->SpiPciBase;
  ...
  )
{
  ...
  if ((mSpiInstance->Flags & FLAGS_SPI_DISABLE_SMM_WRITE_PROTECT) == 0) {
    return;
  }
  ...
  )
{
  ...
  //
  MmioOr8 (SpiBaseAddress + R_SPI_BCR + 1, (B_SPI_BCR_SYNC_SS >> 8));
