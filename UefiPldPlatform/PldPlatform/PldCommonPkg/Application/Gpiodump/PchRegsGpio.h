...
/// PCH:RestrictedBegin
/// @todo: Number of GPIO supporting SMI varies between generations and PCH type
/// PCH SMI dispatcher should provide this value dynamically based on detected PCH.
/// Users of GPI SMI dispatcher protocol nevertheless need to check in EDS/cspec if
/// certain GPIO supports SMI feature. EFI_SMM_GPI_DISPATCH2_PROTOCOL.NumSupportedGpis
/// is for information purpose only but with current implementation it will contain wrong value
/// PCH:RestrictedEnd
