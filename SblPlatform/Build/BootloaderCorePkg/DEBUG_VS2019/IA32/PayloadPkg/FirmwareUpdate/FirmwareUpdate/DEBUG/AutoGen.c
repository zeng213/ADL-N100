...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE2E57F60, 0x4C17, 0x461e, {0x92, 0xA2, 0xE4, 0x28, 0xDB, 0xB1, 0x2D, 0x06}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FirmwareUpdate";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFirmwareUpdateImageFileGuid = { 0x1a3eae58, 0xb580, 0x4fef, { 0xac, 0xa3, 0xa1, 0x6d, 0x9e, 0x00, 0xdf, 0x5f } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gBootLoaderVersionFileGuid = { 0x3473a022, 0xc3c2, 0x4964, { 0xb3, 0x09, 0x22, 0xb3, 0xdf, 0xb0, 0xb6, 0xca } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSblCompFWUpdateImageFileGuid = { 0x66030B7A, 0x47D1, 0x4958, { 0xB7, 0x3D, 0x00, 0xB4, 0x4B, 0x9D, 0xD4, 0xB6 } };
...
volatile  UINT32 _gPcd_BinaryPatch_PcdFwUpdStatusBase = _PCD_PATCHABLE_VALUE_PcdFwUpdStatusBase;
GLOBAL_REMOVE_IF_UNREFERENCED UINTN _gPcd_BinaryPatch_Size_PcdFwUpdStatusBase = 4;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdLowestSupportedFwVer = _PCD_VALUE_PcdLowestSupportedFwVer;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCsmeUpdateEnabled = _PCD_VALUE_PcdCsmeUpdateEnabled;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdUcodeSlotSize = _PCD_VALUE_PcdUcodeSlotSize;
